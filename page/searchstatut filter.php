         ...
         <div class="control-group form-group">
             <div class="controls">
               ...
               <p>Ville:</p>
                              ...
                              $getcommune=isset($_POST['ville']) ? $_POST['ville'] : '';
                              $getrue=isset($_POST['rue']) ? $_POST['rue'] : '';


                              $searchstreet=mysqli_query($cnx,"SELECT ADRESSE1 FROM pbositesverticaux WHERE ADRESSE1 LIKE '%$commune%' ");
                              $ressearchstreet=mysqli_fetch_assoc($searchstreet);

                              $searchnum=mysqli_query($cnx,"SELECT ADRESSE1 FROM pbositesverticaux WHERE ADRESSE1 LIKE '%$commune%' ");
                              $ressearchnum=mysqli_fetch_assoc($searchnum);

                              if($getcommune){
                                echo'<p>Rue°:</p><input type="text" value='$searchcom' class="form-control " id="rue" name="rue" autocomplete="off" onblur="" required="" data-validation-required-message="Veuillez entrez un numéros."  />
                                <p class="help-block"></p>
                                <br>'
                              }
                              if($getrue){
                                echo'<p>N°:</p><input type="text"  value='$searchnum' class="form-control " id="rue" name="rue" autocomplete="off" onblur="" required="" data-validation-required-message="Veuillez entrez un numéros."  />
                                <p class="help-block"></p>
                                <br>'
                              }
